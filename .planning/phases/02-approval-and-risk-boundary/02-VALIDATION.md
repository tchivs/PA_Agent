...
| 02-05-01 | 02-05 | 4 | SIM-03, SAFE-04 | T-02-03, T-02-10, T-02-13 | Controlled proposal/risk audit records survive reopen; complete `phase2-v1` tickets expire at 60 seconds, invalidate on changed evidence, and are consumed once through atomic ledger admission. | unit + integration | `.venv/bin/pytest -q tests/unit/execution/test_approval_ticket.py tests/integration/execution/test_intent_rejections.py tests/integration/execution/test_approval_audit_ledger.py tests/integration/execution/test_approval_consumption.py` | No W0 | pending |
