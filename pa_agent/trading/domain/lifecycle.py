...
_TRANSITIONS: Mapping[tuple[OrderState, LifecycleEvent], OrderState] = {
    ...
    (OrderState.SUBMITTING, LifecycleEvent.CANCELLATION_OBSERVED): OrderState.CANCELLED,
    ...
    (OrderState.ACKNOWLEDGED, LifecycleEvent.CANCELLATION_OBSERVED): OrderState.CANCELLED,
    ...
    (OrderState.OPEN, LifecycleEvent.CANCELLATION_OBSERVED): OrderState.CANCELLED,
    ...
    (OrderState.PARTIALLY_FILLED, LifecycleEvent.CANCELLATION_OBSERVED): OrderState.CANCELLED,
