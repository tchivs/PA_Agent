...
from tests.fixtures.execution_factories import make_account_observation, make_execution_target, make_source_analysis_snapshot
...
def test_accepted_candidate_evidence_fee_and_assessment_are_queryable_after_reopen(
    ...
    assert facts[2].fee_amount == "1.000"
