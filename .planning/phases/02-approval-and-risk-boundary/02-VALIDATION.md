...
|---------|------|------|-------------|------------|-----------------|-----------|-------------------|-------------|--------|
| 02-01-01 | 01 | 1 | CORE-03 | T-02-01 | Invalid, repaired, ambiguous, or unsupported analysis records create durable rejections and never reach a gateway. | unit + integration | `.venv/bin/pytest -q tests/unit/execution/test_intent_factory.py tests/integration/execution/test_intent_rejections.py` | No W0 | pending |
| 02-02-01 | 02 | 2 | SAFE-01, SAFE-02 | T-02-02 | Each risk decision uses a selected target and a complete fresh evidence bundle; stale, missing, contradictory, or unsupported evidence rejects. | unit + integration | `.venv/bin/pytest -q tests/unit/execution/test_execution_target_policy.py tests/unit/execution/test_risk_engine.py tests/integration/execution/test_fresh_evidence_risk.py` | No W0 | pending |
| 02-03-01 | 03 | 3 | SIM-03, SAFE-04 | T-02-03 | Approval tickets expose immutable bound facts, expire, invalidate on changed evidence, and are consumed only once with atomic ledger admission. | unit + integration + property | `.venv/bin/pytest -q tests/unit/execution/test_approval_ticket.py tests/integration/execution/test_approval_audit_ledger.py tests/integration/execution/test_approval_consumption.py` | No W0 | pending |
| 02-04-01 | 04 | 4 | SAFE-03 | T-02-04 | A persisted latch blocks new work across restart, revokes pending tickets, requests eligible cancellation, and requires reconciled explicit recovery. | integration + property | `.venv/bin/pytest -q tests/integration/execution/test_kill_switch.py tests/property/execution/test_approval_kill_switch_machine.py` | No W0 | pending |
| 02-05-01 | 05 | 5 | SAFE-05 | T-02-05 | Generic settings, audit events, logging, notification payloads, exceptions, and test artifacts retain no synthetic secrets. | unit + integration | `.venv/bin/pytest -q tests/unit/execution/test_secret_redaction.py tests/integration/execution/test_secret_nonpersistence.py` | No W0 | pending |
